...
int
cc_array_stack_push (struct cc_array_stack *self, void *item)
{
...
int
cc_array_stack_pop (struct cc_array_stack *self, void *item)
{
  if (self->top == 0)
...
int
cc_array_stack_peek (struct cc_array_stack *self, void *item)
{
  if (self->top == 0)
    return CC_STACK_EMPTY;
...
size_t
cc_array_stack_elem_nums (struct cc_array_stack *self)
{
  return self->top;
}

size_t
cc_array_stack_space (struct cc_array_stack *self)
{
  return self->data->elem_nums - self->top;
}

int
cc_array_stack_init (struct cc_array_stack *self, struct cc_array *data)
{
...
int
cc_array_stack_new (struct cc_array_stack **self, size_t elem_nums,
                    size_t elem_size)
{
...
int
cc_array_stack_delete (struct cc_array_stack *self)
{
