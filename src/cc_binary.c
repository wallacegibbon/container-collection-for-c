...
int
cc_binary_insert_left (struct cc_binary *self, void *data)
{
...
int
cc_binary_insert_right (struct cc_binary *self, void *data)
{
  struct cc_binary *node;
  if (cc_binary_new (&node, self, data))
    return 1;
...
int
cc_binary_rotate_left (struct cc_binary **start_slot)
{
...
int
cc_binary_rotate_right (struct cc_binary **start_slot)
{
  struct cc_binary *start = *start_slot;
...
int
cc_binary_new (struct cc_binary **self, struct cc_binary *parent, void *data)
{
...
int
cc_binary_delete (struct cc_binary *self)
{
  if (self == NULL)
    return 0;
...
int
cc_binary_print (struct cc_binary *current, int depth,
...
static int
iter_queue_add (struct cc_binary_iter *self, void *data)
{
  if (data == NULL)
    return 0;
...
static int
iter_queue_add_multi (struct cc_binary_iter *self, int n, ...)
{
  va_list args;
  va_start (args, n);
  while (n-- > 0)
...
static int
iter_queue_add_child (struct cc_binary_iter *self, struct cc_binary *node)
{
  int tmp = 0;
...
int
cc_binary_iter_next (struct cc_binary_iter *self, void **item, size_t *index)
{
...
int
cc_binary_iter_new (struct cc_binary_iter **self, struct cc_binary *root,
...
int
cc_binary_iter_delete (struct cc_binary_iter *self)
{
  int tmp = 0;
