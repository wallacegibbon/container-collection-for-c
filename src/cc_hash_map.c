...
static inline void
get_list_map_ref (struct cc_hash_map *self, void *key,
...
int
cc_hash_map_get (struct cc_hash_map *self, void *key, void **result)
{
...
int
cc_hash_map_set_new (struct cc_hash_map *self, void *key, void *value)
{
  struct cc_list_map **list_map_ref;
...
int
cc_hash_map_set (struct cc_hash_map *self, void *key, void *value,
                 void **old_value)
{
  struct cc_list_map **list_map_ref;
...
int
cc_hash_map_del (struct cc_hash_map *self, void *key,
...
int
cc_hash_map_print_slot (struct cc_list_map *slot, int index)
{
...
int
cc_hash_map_print (struct cc_hash_map *self, char *end_string)
{
...
int
cc_hash_map_new (struct cc_hash_map **self, size_t bucket_size,
...
int
cc_hash_map_delete (struct cc_hash_map *self)
{
  struct cc_array_iter iter;
  struct cc_list_map **item;
...
static int
cc_hash_map_iter_step (struct cc_hash_map_iter *self)
{
...
int
cc_hash_map_iter_next (struct cc_hash_map_iter *self, void **item,
                       size_t *index)
{
...
int
cc_hash_map_iter_init (struct cc_hash_map_iter *self, struct cc_hash_map *map)
{
  int tmp;
  ...
  /// `hash_map`'s `init` will call `step`, which is dangerous. Be careful with
  /// code here.
