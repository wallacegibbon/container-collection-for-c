...
int cc_list_cursor_relative_next(cc_ListCursor *self, int offset,
		cc_ListNode **result)
{
	cc_ListNode *node;
	/*
...
int cc_list_cursor_relative_prev(cc_ListCursor *self, int offset,
		cc_ListNode **result)
{
	cc_ListNode *node;
	/*
...
int cc_list_cursor_insert_before(cc_ListCursor *self, int offset, void *data)
{
	cc_ListNode *node;
...
*/
int cc_list_cursor_get(cc_ListCursor *self, int offset, int count, void **result)
{
	cc_ListNode *node;
	int i;
...
int cc_list_cursor_init(cc_ListCursor *self, cc_List *list, cc_DelFn remove_fn)
{
...
static inline void cc_list_iter_step(cc_ListIter *self)
{
	if (self->direction == 0)
...
int cc_list_node_delete_and_next(cc_ListNode **pcurrent, cc_DelFn remove_fn)
{
...
static inline void cc_list_reset(cc_List *self)
{
