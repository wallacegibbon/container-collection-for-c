...
////////////////////////////////////////////////////////////////////////////////
int
cc_list_cursor_relative_next (struct cc_list_cursor *self, int offset,
                              struct cc_list_node **result)
{
  struct cc_list_node *node;
  /// The `last` element can be the root node, so it's `n != &self->list->root`
  /// here
...
int
cc_list_cursor_relative_prev (struct cc_list_cursor *self, int offset,
                              struct cc_list_node **result)
{
  struct cc_list_node *node;
  /// The `first` element can NOT be the root node, so it's `n->prev !=
  /// &self->list->root` here
  for (node = self->current; node->prev != &self->list->root && offset > 0;
       offset--)
    node = node->prev;
...
int
cc_list_cursor_relative_pos (struct cc_list_cursor *self, int offset,
                             struct cc_list_node **result)
{
  if (offset >= 0)
...
int
cc_list_cursor_insert_before (struct cc_list_cursor *self, int offset,
                              void *data)
{
  struct cc_list_node *node;
...
int
cc_list_cursor_remove (struct cc_list_cursor *self, int offset, int count)
{
...
/// Caution: Please make sure that `result` can hold `count` numbers of
/// pointers.
int
cc_list_cursor_get (struct cc_list_cursor *self, int offset, int count,
                    void **result)
{
  struct cc_list_node *node;
  int i;
...
int
cc_list_cursor_move (struct cc_list_cursor *self, int offset)
{
...
int
cc_list_cursor_at_end (struct cc_list_cursor *self)
{
  return self->current == &self->list->root;
}

void
cc_list_cursor_reset (struct cc_list_cursor *self)
{
  self->current = self->list->root.next;
}

int
cc_list_cursor_init (struct cc_list_cursor *self, struct cc_list *list,
...
int
cc_list_cursor_new (struct cc_list_cursor **self, struct cc_list *list,
                    cc_delete_fn_t remove_fn)
{
...
int
cc_list_cursor_delete (struct cc_list_cursor *self)
{
  free (self);
  return 0;
}
...
////////////////////////////////////////////////////////////////////////////////
static inline void
cc_list_iter_step (struct cc_list_iter *self)
{
  if (self->direction == 0)
...
int
cc_list_iter_next (struct cc_list_iter *self, void **item, size_t *index)
{
  if (item == NULL)
    return 1;
...
int
cc_list_iter_init (struct cc_list_iter *self, struct cc_list *list,
                   int direction)
{
  if (list == NULL)
    return 1;
...
////////////////////////////////////////////////////////////////////////////////
int
cc_list_node_insert_before (struct cc_list_node *self, void *data)
{
  struct cc_list_node *node;
...
int
cc_list_node_insert_after (struct cc_list_node *self, void *data)
{
  struct cc_list_node *node;
...
int
cc_list_node_remove_before (struct cc_list_node *self, void **result)
{
  struct cc_list_node *node;
...
int
cc_list_node_remove_after (struct cc_list_node *self, void **result)
{
  struct cc_list_node *node;
...
int
cc_list_node_delete_and_next (struct cc_list_node **pcurrent,
                              cc_delete_fn_t remove_fn)
{
...
////////////////////////////////////////////////////////////////////////////////
int
cc_list_to_cc_array (struct cc_list *self, struct cc_array **result)
{
...
static inline void
cc_list_reset (struct cc_list *self)
{
...
int
cc_list_concat (struct cc_list *left, struct cc_list *right)
{
...
int
cc_list_insert_head (struct cc_list *self, void *data)
{
...
int
cc_list_insert_tail (struct cc_list *self, void *data)
{
...
int
cc_list_remove_head (struct cc_list *self, void **data)
{
...
int
cc_list_remove_tail (struct cc_list *self, void **data)
{
  if (cc_list_is_empty (self))
    return CC_LIST_EMPTY;
...
int
cc_list_get_head (struct cc_list *self, void **data)
{
  if (cc_list_is_empty (self))
    return CC_LIST_EMPTY;
...
int
cc_list_get_tail (struct cc_list *self, void **data)
{
  if (cc_list_is_empty (self))
    return CC_LIST_EMPTY;
...
int
cc_list_is_empty (struct cc_list *self)
{
  return self->root.next == &self->root;
}

size_t
cc_list_size (struct cc_list *self)
{
  return self->root.size;
}

int
cc_list_new (struct cc_list **self)
{
  struct cc_list *tmp;
  tmp = malloc (sizeof (*tmp));
  if (tmp == NULL)
...
int
cc_list_print (struct cc_list *self, int direction)
{
  struct cc_list_iter iter;
  size_t *tmp;
  size_t index;
