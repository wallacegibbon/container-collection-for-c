...
static inline int
cc_list_map_get_current (struct cc_list_map *self, struct cc_map_item **item)
{
...
static int
cc_list_map_move_to_item (struct cc_list_map *self, void *key)
{
...
int
cc_list_map_get (struct cc_list_map *self, void *key, void **result)
{
...
int
cc_list_map_insert_new (struct cc_list_map *self, void *key, void *value)
{
  struct cc_map_item *item;
...
int
cc_list_map_set_new (struct cc_list_map *self, void *key, void *value)
{
  struct cc_map_item *item;
...
/// Be careful! When `old_value` is NULL, the old value of `key` will be
/// ignored, which may cause memory leak.
int
cc_list_map_set (struct cc_list_map *self, void *key, void *value,
                 void **old_value)
{
  struct cc_map_item *item;
...
int
cc_list_map_del (struct cc_list_map *self, void *key,
...
int
cc_list_map_print (struct cc_list_map *self, char *end_string)
{
...
int
cc_list_map_new (struct cc_list_map **self, cc_cmp_fn_t cmp)
{
...
int
cc_list_map_delete (struct cc_list_map *self)
{
...
int
cc_list_map_iter_next (struct cc_list_map_iter *self, void **item,
                       size_t *index)
{
...
int
cc_list_map_iter_init (struct cc_list_map_iter *self, struct cc_list_map *map)
{
  if (map == NULL)
    return 1;
