...
int
cc_list_queue_enqueue (struct cc_list_queue *self, void *data)
{
  return cc_list_insert_tail (self->list, data);
}

int
cc_list_queue_dequeue (struct cc_list_queue *self, void **result)
{
  return translate_code (cc_list_remove_head (self->list, result));
}

int
cc_list_queue_peek (struct cc_list_queue *self, void **result)
{
  return translate_code (cc_list_get_head (self->list, result));
}

int
cc_list_queue_new (struct cc_list_queue **self)
{
...
int
cc_list_queue_delete (struct cc_list_queue *self)
{
