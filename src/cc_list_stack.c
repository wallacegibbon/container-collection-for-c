...
int
cc_list_stack_push (struct cc_list_stack *self, void *data)
{
  return cc_list_insert_head (self->list, data);
}

int
cc_list_stack_pop (struct cc_list_stack *self, void **result)
{
  return translate_code (cc_list_remove_head (self->list, result));
}

int
cc_list_stack_peek (struct cc_list_stack *self, void **result)
{
  return translate_code (cc_list_get_head (self->list, result));
}

int
cc_list_stack_new (struct cc_list_stack **self)
{
...
int
cc_list_stack_delete (struct cc_list_stack *self)
{
