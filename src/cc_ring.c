...
next_index (struct cc_ring *self, size_t index)
{
...
size_t
cc_ring_elem_nums (struct cc_ring *self)
{
...
size_t
cc_ring_space (struct cc_ring *self)
{
  return self->data->elem_nums - cc_ring_elem_nums (self) - 1;
}

int
cc_ring_enqueue (struct cc_ring *self, void *item)
{
...
int
cc_ring_peek (struct cc_ring *self, void *item)
{
...
int
cc_ring_dequeue (struct cc_ring *self, void *item)
{
...
int
cc_ring_init (struct cc_ring *self, struct cc_array *data)
{
...
int
cc_ring_new (struct cc_ring **self, size_t elem_nums, size_t elem_size)
{
  struct cc_ring *tmp;
...
int
cc_ring_delete (struct cc_ring *self)
{
