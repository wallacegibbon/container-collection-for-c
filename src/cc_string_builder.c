...
int
cc_string_builder_to_string (struct cc_string_builder *self, char **result)
{
  struct cc_array *arr;
  char zero = '\0';
...
int
cc_string_builder_append_str (struct cc_string_builder *self, char *s)
{
  if (s == NULL)
    return 0;
...
/// When `s` is NULL, ignore and return success directly
int
cc_string_builder_append (struct cc_string_builder *self, char *s, size_t size)
{
  if (s == NULL)
    return 0;
...
int
cc_string_builder_new (struct cc_string_builder **self)
{
...
int
cc_string_builder_delete (struct cc_string_builder *self)
{
