...
main (void)
{
  ...
  /// The list has only 14 elements from the `current` pointer now. (16
  /// elements in total)
  ...
  /// The list has only 13 elements from the `current` pointer now. (15
  /// elements in total)
  ...
  /// The list has only 14 elements from the `current` pointer now. (15
  /// elements in total)
  ...
  /// The list has only 12 elements after the `current` pointer now. (13
  /// elements in total)
  ...
  /// The list has only 13 elements after the `current` pointer now. (14
  /// elements in total)
